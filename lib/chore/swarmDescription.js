...
function SwarmDescription(swarmTypeName, description){
    ...
    this.initialiseFunctions = function(valueObject, thisObject){
        ...
        function waitResults(callback, swarm, keepAliveCheck){
            if(!swarm){
                swarm = this;
            }
            if(!keepAliveCheck){
        ...
        valueObject.myFunctions["wait"]  = waitResults;
...
function cleanSwarmWaiter(swarmSerialisation){
